...
fun PreferenceItemCard(
    ...
    iconBackground: Color = NeobrutalismTheme.colors.accentYellow,
    iconTint: Color = NeobrutalismTheme.colors.border,
    testTag: String? = null
) {
            ...
            Row(
                ...
                if (!valueText.isNullOrBlank()) {
                    Box(
                        modifier = Modifier
                            .background(
                                NeobrutalismTheme.colors.background,
                                RoundedCornerShape(6.dp)
                            )
                            .border(
                                1.5.dp,
                                NeobrutalismTheme.colors.border,
                                RoundedCornerShape(6.dp)
                            )
