...
fun BookmarkTagsSection(
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.bookmark_tags_heading),
            ...
            Box(
                ...
                Row(
                    ...
                    Icon(
                        ...
                        contentDescription = stringResource(R.string.bookmark_add_tag_dialog_title),
                        tint = NeobrutalismTheme.colors.border,
                        modifier = Modifier.size(16.dp)
                    )
                    Spacer(modifier = Modifier.width(4.dp))
                    Text(
                        text = stringResource(R.string.bookmark_add_tag_button),
...
fun AddTagDialog(
    ...
    Dialog(onDismissRequest = onDismiss) {
        Box(
            ...
            Column {
                Text(
                    text = stringResource(R.string.bookmark_add_tag_dialog_title),
                ...
                Box(
                    ...
                    if (tagInput.isEmpty()) {
                        Text(
                            text = stringResource(R.string.bookmark_add_tag_input_hint),
                ...
                Row(
                    ...
                    NeobrutalistButton(
                        text = stringResource(R.string.bookmark_add_tag_confirm),
                        onClick = onSaveTag,
