...
fun BookmarkNotesSection(
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.bookmark_notes_heading),
        ...
        if (isEditing) {
            Column(
                ...
                Box(
                    ...
                    if (editedNotes.isEmpty()) {
                        Text(
                            text = stringResource(R.string.bookmark_notes_editing_placeholder),
            ...
            Box(
                ...
                if (!notes.isNullOrBlank()) {
                    ...
                    Text(
                        text = stringResource(R.string.bookmark_notes_placeholder),
                        style = NeobrutalismTheme.typography.bodyMedium.copy(
                            fontSize = 14.sp
                        ),
                        color = NeobrutalismTheme.colors.subtext
