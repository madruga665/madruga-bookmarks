        ...
        Row(
            ...
            NeobrutalistButton(
                ...
                Icon(
                    ...
                    contentDescription = stringResource(R.string.bookmark_btn_refresh),
                    tint = NeobrutalismTheme.colors.onSurface,
            ...
            NeobrutalistButton(
                ...
                Icon(
                    ...
                    contentDescription = stringResource(R.string.bookmark_btn_share),
                    tint = NeobrutalismTheme.colors.onSurface,
                    modifier = Modifier.size(18.dp)
                )
            }
            ...
            NeobrutalistButton(
                ...
                Icon(
                    ...
                    contentDescription = stringResource(R.string.bookmark_btn_move),
                    tint = NeobrutalismTheme.colors.onSurface,
                    modifier = Modifier.size(18.dp)
                )
            }
            ...
            NeobrutalistButton(
                ...
                Icon(
                    ...
                    contentDescription = stringResource(R.string.bookmark_btn_delete),
                    tint = Color.White,
                    modifier = Modifier.size(18.dp)
                )
            }
